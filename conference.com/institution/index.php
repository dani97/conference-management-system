...
$start= ($page-1) * 10;
$rows = Institution::showConference(0,10);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="add.html">addConference</a></li>
      </ul>
...
<div class="container text-center">
  <div class="row">
    <div class="col-sm-4 well">
      <div class="well">
        <p><a href="#"><?php echo $_SESSION['insname']?></a></p>
        <img src="../assets/img/user.png" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
        ...
        <p>
          ...
          <span class="label label-warning"><?php echo $_SESSION['address']?></span></br>
      ...
      echo"<div class='row'>
        <div class='col-sm-12'>
		  ...
		  <a href='".$row['url']."'>
			...
			<input type='hidden' name='ins' value='".$_SESSION['insname']."'>
